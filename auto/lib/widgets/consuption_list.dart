...
class ConsumptionList extends StatelessWidget {
  final Auto auto;
  const ConsumptionList({super.key, required this.auto});
  @override
  Widget build(BuildContext context) {
    return  auto.consumptionList.isEmpty
            ...
            child: ExpandablePanel(
              ...
              expanded: Container(
                ...
                child:  ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: auto.consumptionList.length,
                  itemBuilder: (context, index) {
                    return EquipmentVeichle(
                        description: auto.consumptionList[index]);
                  },
                ),
              ),
